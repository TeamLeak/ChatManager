...
dependencies {
    ...
    compileOnly("me.clip:placeholderapi:2.11.6")      // PAPI (compileOnly)
    implementation("net.kyori:adventure-text-minimessage:4.17.0")
    implementation("org.xerial:sqlite-jdbc:3.45.3.0")
    implementation("net.dv8tion:JDA:5.0.0")                 // Discord JDA v5
    implementation("org.slf4j:slf4j-simple:2.0.13")         // простой логгер для JDA

    implementation("org.telegram:telegrambots-abilities:9.0.0")
